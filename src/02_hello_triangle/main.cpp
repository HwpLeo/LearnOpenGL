...
int main()
{
    ...
    unsigned shader_program = create_shader(vertex_shader_source, fragment_shader_source);
    unsigned shader_program_1 = create_shader(vertex_shader_source, fragment_shader_source_1);
